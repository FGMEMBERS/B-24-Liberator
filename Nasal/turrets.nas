...
var turret=
{
  ...
  new: func(name,index, view_number,heading_path,pitch_path,minhead, maxhead,headdegsec,minpitch, maxpitch,pitchdegsec)
  {
    ...
    print (name ~ " created using view " ~ view_number ~ " and properties " ~ heading_path ~ " and " ~ pitch_path);
...
#création de l'objet    
var tourelledetoit = turret.new("Tourelle_de_Toit",0,9,"sim/model/turret[0]/heading","sim/model/turret[0]/pitch",0,0,60,0,60,60);
# var DownTurret = turret.new("DownTurret",1,10,"sim/model/turret[1]/heading","sim/model/turret[1]/pitch",0,0,60,-80,0,60);
# var CenterRight = turret.new("CenterRight",2,11,"sim/model/turret[2]/heading","sim/model/turret[2]/pitch",10,170,60,-70,70,60);
# var CenterLeft = turret.new("CenterRight",3,11,"sim/model/turret[3]/heading","sim/model/turret[3]/pitch",190,350,60,-70,70,60);
# var Nose = turret.new("Nose",4,13,"sim/model/turret[4]/heading","sim/model/turret[4]/pitch",270,90,60,-70,20,60);
